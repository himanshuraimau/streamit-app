...
- [ ] 5. Backend - Update Stream Go-Live Logic
  - [ ] 5.1 Update go-live to set startedAt and create StreamStats
    - Set startedAt timestamp when stream goes live
    - Create StreamStats record for the stream
    - _Requirements: 1.1, 1.3_
  - [ ] 5.2 Update end-stream to set endedAt in StreamStats
...
- [ ] 7. Frontend Utilities - Duration Calculation
  - [ ] 7.1 Create formatDuration utility function
...
- [ ] 8. Frontend Utilities - Local Storage Preferences
  - [ ] 8.1 Create viewer preferences storage utilities
...
- [ ] 9. Frontend Utilities - Message Filtering
  - [ ] 9.1 Create blocked user message filter function
...
- [ ] 10. Frontend Component - StreamDurationTimer
  - [ ] 10.1 Create StreamDurationTimer component
...
- [ ] 11. Frontend Component - LikeButton (Penny Tip)
  - [ ] 11.1 Create LikeButton component
  ...
  - [ ] 11.2 Create HeartBurstAnimation component
    - Implement floating hearts animation using framer-motion
    - Trigger on successful penny tip
    - _Requirements: 3.2_

- [ ] 12. Frontend Component - ReportStreamDialog
  - [ ] 12.1 Create ReportStreamDialog component
...
- [ ] 13. Frontend Component - EngagementPopup
  - [ ] 13.1 Create EngagementPopup component
...
- [ ] 14. Frontend Component - ChatVisibilityToggle
  - [ ] 14.1 Create ChatVisibilityToggle component
    - Display toggle button for chat visibility
    - Persist preference to localStorage
    - Restore preference on mount
    - _Requirements: 6.1, 6.2, 6.3_

- [ ] 15. Frontend Component - BlockedUsersContext
  - [ ] 15.1 Create BlockedUsersContext provider
    - Implement context with blockedUserIds, blockUser, unblockUser, isBlocked
    - Persist to localStorage
    - Provide hook useBlockedUsers
    - _Requirements: 7.2, 7.3, 7.4_
  - [ ] 15.2 Add block user context menu to chat messages
    - Add right-click/long-press context menu
    - Show "Block User" option
    - Integrate with BlockedUsersContext
    - _Requirements: 7.1_

- [ ] 16. Checkpoint - Core Components Complete
  - Ensure all component tests pass
  - Verify components render correctly in isolation
  - Ask the user if questions arise

- [ ] 17. Frontend Component - ImmersiveModeOverlay
  - [ ] 17.1 Create ImmersiveModeOverlay component
  ...
  - [ ] 17.3 Add touch device detection
...
- [ ] 18. Frontend Component - PostStreamSummary
  - [ ] 18.1 Create PostStreamSummary modal component
  ...
  - [ ] 18.3 Implement recommended stream navigation
    - Handle click on recommended stream
    - Navigate to selected stream
    - _Requirements: 9.6_

- [ ] 19. Frontend - LiveKit Data Channel Integration
  - [ ] 19.1 Create engagement event types and handlers
  ...
  - [ ] 19.2 Integrate data channel with EngagementPopup
