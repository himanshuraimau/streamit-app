  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-muted-foreground">Most popular streams in selected period</p>
          </div>
        </div>
      ...
      <div className="grid gap-4 md:grid-cols-3">
        ...
        <Card>
          <CardHeader>
            <CardTitle className="text-sm font-medium text-muted-foreground">Total Peak Viewers</CardTitle>
          </CardHeader>
          <CardContent>
            <p className="text-2xl font-bold">
              {formatNumber(streams?.reduce((sum, s) => sum + s.views, 0) || 0)}
            </p>
          </CardContent>
        </Card>
        <Card>
          ...
          <CardContent>
            <p className="text-2xl font-bold">
              {formatNumber(streams?.reduce((sum, s) => sum + s.engagement, 0) || 0)}
            </p>
          </CardContent>
        </Card>
      </div>
