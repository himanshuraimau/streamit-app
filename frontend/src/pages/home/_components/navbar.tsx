        ...
        <div className="hidden md:flex flex-1 max-w-md mx-8">
          <div className="relative w-full">
            ...
            <input
              ...
              className="w-full rounded-full bg-zinc-900 py-2 pl-10 pr-4 text-sm text-white placeholder:text-zinc-400 focus:outline-none focus:ring-2 focus:ring-purple-500"
            />
          </div>
        </div>
